...
( function () {
	...
	function startBgImg() {
		TweenMax.fromTo("#bg-img", 7, {scale:0.67,x:-120, y:-30}, {scale:0.75,x:-160, y:-35, ease:Linear.easeInOut, transformStyle: "preserve-3d", autoAlpha:1, force3D:true, rotationZ: 0.01});
	}
