...
( function () {
	...
	function startBgImg() {
		TweenMax.fromTo("#bg-img", 7, {x:-150, y:-125,scale:1}, {x:-75, y:-125, scale:0.5, ease:Linear.easeInOut, transformStyle: "preserve-3d", autoAlpha:1, force3D:true, rotationZ: 0.01});
	}
