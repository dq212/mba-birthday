...
( function () {
	...
	function startBgImg() {
		TweenMax.fromTo("#bg-img", 7, {x:-50, y:-280, scale:0.55}, {x:-55, y:-230, scale:0.65, ease:Linear.easeInOut, transformStyle: "preserve-3d", autoAlpha:1, force3D:true, rotationZ: 0.01});
	}
