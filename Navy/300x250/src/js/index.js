...
( function () {
	...
	function startBgImg() {
		TweenMax.fromTo("#bg-img", 7, {scale:0.6, x:-105, y:-100}, {scale:0.5, x:-75, y:-125, ease:Linear.easeInOut, transformStyle: "preserve-3d", autoAlpha:1, force3D:true, rotationZ: 0.01});
	}
