...
( function () {
	...
	function startBgImg() {
		TweenMax.fromTo("#bg-img", 7, {scale:0.9, y:-40, x:-40}, {scale:1, y:0, x:-20, ease:Linear.easeInOut, transformStyle: "preserve-3d", autoAlpha:1, force3D:true, rotationZ: 0.01});
	}
